...
#Computer:Path
#W11-CLI001:OU=Equipos-DepInf,OU=Dep-Informatica
#W11-CLI002:OU=Equipos-DepInf,OU=Dep-Informatica
#Es decir, queremos crear los equipos, en la OU Equipos-DepInf que esta dentro de la OU Dep-Informatica
#Por lo tanto para crear el equipo en esa ruta sobre el dominio si.mylocal quedaría así:
#OU=Equipos-DepInf,OU=Dep-Informatica,DC=si,DC=mylocal
